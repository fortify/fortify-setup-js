...
- **[fcli tool env commands]({{var:fcli-url}}/tree/main/fcli-core/fcli-tool/src/main/java/com/fortify/cli/tool/env/cli/cmd)** - The fcli commands that @fortify/setup wraps
